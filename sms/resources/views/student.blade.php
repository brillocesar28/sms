    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://png.pngtree.com/back_origin_pic/04/08/32/0b71be98885437a0e17a485851fa073b.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="courseCode" type="text" class="form-control"  placeholder="Enter Course Code">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Course Code</label>
                                <input value="{{ $student->courseCode }}" name="courseCode" type="text" class="form-control"  placeholder="Enter Course Code">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
